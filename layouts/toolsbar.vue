      ...
      <div class="flex justify-between">
        <div class="flex gap-2">
          ...
          >
            <Button
              icon="pi pi-bell"
              :severity="curTab === Tab.NOTIFICATION ? 'primary' : 'secondary'"
              rounded
              outlined
          ...
          <Button
            icon="pi pi-cog"
            :severity="curTab === Tab.SETTINGS ? 'primary' : 'secondary'"
            rounded
            outlined
            v-tooltip="'Settings'"
            aria-label="Settings"
        ...
        <Popover ref="op" class="pt-4">
          ...
          >
            ...
            <div class="flex flex-col w-full gap-2">
              ...
              />
              <Button @click="handleSignOut" label="Logout" severity="danger" />
            </div>
          </div>
        </Popover>
      </div>
